...
export class UploadWithdrawalExcelDto {
  @ApiProperty({
    type: "string",
    format: "binary",
  ...
  @ApiProperty({ example: "A", description: "출금일자 열 인덱스" })
  @IsString()
  ...
  @ApiProperty({ example: "C", description: "출금액 열 인덱스" })
  @IsString()
  ...
  @ApiProperty({ example: "H", description: "용도 열 인덱스" })
  @IsString()
  purposeIndex: string;

  @ApiProperty({ example: "I", description: "거래처 열 인덱스" })
  @IsString()
